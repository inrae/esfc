...
-- psql -h serveur -U login base_de_donnees -f gacl_pgsql_schema_gacl_login_18-02-2014.sql
-- les commandes d'attribution des droits sont en fin de fichier
-- 
-- 
...
grant all on all tables in schema gacl to sturio_gacl_g;
grant all on all sequences in schema gacl to sturio_gacl_g;
