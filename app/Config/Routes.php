...
$routes->add('devenirTypeList', 'DevenirType::list');
$routes->add('devenirTypeChange', 'DevenirType::change');
$routes->post('devenirTypeWrite', 'DevenirType::write');
$routes->post('devenirTypeDelete', 'DevenirType::delete');
