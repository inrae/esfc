...
<div class="row">
    <div class="col-md-6">
        <table class="table table-bordered table-hover datatable-nopaging" id="repartitionList">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    {if $droits.bassinGestion == 1}
                    <td class="center">
                        <a href="index.php?module=repartitionResteChange&repartition_id={$dataList[lst].repartition_id}"
