...
<a href="pittagTypeList">{t}Retour à la liste{/t}</a>

<div class="row">
    <div class="col-md-6">
        <form class="form-horizontal" id="pittagTypeForm" method="post" action="pittagTypeWrite">
            ...
            <div class="form-group center">
                ...
                {if $data.pittag_type_id > 0 &&$rights["paramAdmin"] == 1}
