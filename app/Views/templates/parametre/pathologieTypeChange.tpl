...
<a href="pathologieTypeList">{t}Retour à la liste{/t}</a>

<div class="row">
    <div class="col-md-6">
        <form class="form-horizontal" id="pathologieTypeForm" method="post" action="pathologieTypeWrite">
            ...
            <div class="form-group center">
                ...
                {if $data.pathologie_type_id > 0 &&$rights["paramAdmin"] == 1}
