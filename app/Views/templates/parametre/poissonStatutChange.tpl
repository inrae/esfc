...
<a href="poissonStatutList">{t}Retour à la liste{/t}</a>

<div class="row">
    <div class="col-md-6">
        <form class="form-horizontal" id="poissonStatutForm" method="post" action="poissonStatutWrite">
            ...
            <div class="form-group center">
                ...
                {if $data.poisson_statut_id > 0 &&$rights["paramAdmin"] == 1}
