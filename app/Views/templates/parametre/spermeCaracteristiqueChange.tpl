...
<a href="spermeCaracteristiqueList">{t}Retour à la liste{/t}</a>


<div class="row">
    <div class="col-md-6">
        <form class="form-horizontal" id="caracteristiqueForm" method="post" action="spermeCaracteristiqueWrite">            
            ...
            <div class="form-group center">
                ...
                {if $data.sperme_caracteristique_id > 0 &&($rights["paramAdmin"] == 1 || $rights.reproAdmin == 1)}
