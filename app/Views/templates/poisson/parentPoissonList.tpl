...
<td>
<div class="center">
<a href="parentPoissonChange?poisson_id={$dataPoisson.poisson_id}&parent_poisson_id={$dataParent[lst].parent_poisson_id}">
...
{/if}
<td>
<a href="poissonDisplay?poisson_id={$dataParent[lst].parent_id}">
