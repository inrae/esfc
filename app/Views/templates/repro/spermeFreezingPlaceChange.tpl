...
<a href="{$poissonDetailParent}?sequence_id={$dataCongelation.sequence_id}">
...
<div class="row">
    <div class="col-md-6">
        <form class="form-horizontal" id="spermeFreezingPlaceForm" method="post" action="spermeFreezingPlaceWrite">            
            ...
            <div class="form-group center">
                ...
                {if $data.sperme_freezing_place_id > 0 &&$rights["reproGestion"] == 1}
