<table class="table table-bordered table-hover datatable-nopaging-nosearching ok" id="csequence" data-tabicon="okreproduction">
    ...
    <tbody>
        ...
        <tr>
            <td>
                <a
                    href="poissonSequenceChange?poisson_sequence_id={$dataSequence[lst].poisson_sequence_id}&sequence_id={$dataSequence[lst].sequence_id}&poisson_campagne_id={$dataSequence[lst].poisson_campagne_id}">
