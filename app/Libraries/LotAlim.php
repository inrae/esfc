...
use App\Models\AlimentQuotidien;
use App\Models\BassinLot;
use App\Models\DistribQuotidien;
use App\Models\Lot;
use App\Models\LotMesure;
use App\Models\LotRepartTemplate;
use App\Models\Repartition;
use App\Models\RepartitionJuvenileLot;
use Ppci\Libraries\PpciException;
use Ppci\Libraries\PpciLibrary;

class LotAlim extends PpciLibrary
{
	private $idDataQuotidien = 0;
	/**
	 * @author Eric Quinton
	...
	function generate()
	{
		...
		try {
			...
			if ($error) {
				throw new PpciException(_("Certains lots ne sont pas affectés dans des bassins"));
			}
