...
<script type="text/javascript" charset="utf-8" src="display/javascript/jqueryValidate/jquery.validate.min.js"></script>
<script type="text/javascript" charset="utf-8" src="display/javascript/jqueryValidate/messages_fr.js"></script>
