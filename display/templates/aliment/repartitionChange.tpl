...
<form id="repartitionForm" method="post" action="index.php">
	...
	<div class="row">
		<div class="col-md-6 form-horizontal">
			...
			<div class="form-group">
				<label for="date_debut_periode" class="control-label col-md-4">{t}Date début :{/t}</label>
				<div class="col-md-8">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<input id="" class="form-control" class="date" name="date_fin_periode"
		...
		<div class="col-xs-12">
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				...
				<li class="nav-item {if $i==0}active{/if}">
					<a class="nav-link" id="tab-{$bassin.bassin_id}" href="#nav-{$bassin.bassin_id}" data-toggle="tab"
						role="tab" aria-controls="nav-{$bassin.bassin_id}" aria-selected="false">
						<img src="display/images/movement.png" height="25">
						{$bassin.bassin_nom}
						<img id="ok{$bassin.bassin_id}" src="display/images/ok_icon.png" height="15" hidden>
					</a>
				</li>
				{$i++}
				{/foreach}
			...
			<div class="tab-content" id="nav-tabContent">
				...
				<div class="tab-pane {if $i == 0} active in{else}fade{/if}" id="nav-{$dataBassin[lst].bassin_id}"
					role="tabpanel" aria-labelledby="tab-{$dataBassin[lst].bassin_id}">
					...
					<div class="form-group">
						<label for="repart_template_id_{$dataBassin[lst].bassin_id}" class="control-label col-md-4">
							{t}Modèle de distribution utilisé :{/t}<span class="red">*</span>
						</label>
						<div class="col-md-8">
							<select id="repart_template_id_{$dataBassin[lst].bassin_id}" class="form-control" name="repart_template_id_{$dataBassin[lst].bassin_id}"
								id="repart_template_id_{$dataBassin[lst].bassin_id}">
								<option value="0" {if $dataBassin[lst].repart_template_id==0}selected{/if}>
					...
					<div class="form-group">
						<label for="distribution_masse_{$dataBassin[lst].bassin_id}" class="control-label col-md-4">
							{t}Masse (poids) des poissons dans le bassin (en grammes) :{/t}
						</label>
						<div class="col-md-8">
							<input class="form-control" class="nombre masse"
								name="distribution_masse_{$dataBassin[lst].bassin_id}"
								id="distribution_masse_{$dataBassin[lst].bassin_id}"
								value="{$dataBassin[lst].distribution_masse}" data-cle="{$dataBassin[lst].bassin_id}">
							<input type="btn btn-warning" class="calcul" data-cle="{$dataBassin[lst].bassin_id}"
								value="{t}Recalcul...{/t}">
						</div>
					</div>
					<div class="form-group">
						...
						<dd>
							...
							<input name="taux_nourrissage_precedent_{$dataBassin[lst].bassin_id}"
								...
								value="{$dataBassin[lst].taux_nourrissage_precedent}" class="num5" readonly>
							Qté :
							<input class="num5" name="total_distrib_precedent_{$dataBassin[lst].bassin_id}"
							...
							<br>Reste :
							<input class="num5" name="reste_precedent_{$dataBassin[lst].bassin_id}"
								id="reste_precedent_{$dataBassin[lst].bassin_id}"
								data-cle="{$dataBassin[lst].bassin_id}" value="{$dataBassin[lst].reste_precedent}"
								readonly>
							% reste :
							<input class="num5" name="taux_reste_precedent_{$dataBassin[lst].bassin_id}"
								value="{$dataBassin[lst].taux_reste_precedent}" readonly>
							<br>
							<input name="ration_commentaire_precedent_{$dataBassin[lst].bassin_id}"
								id="ration_commentaire_precedent_{$dataBassin[lst].bassin_id}"
								data-cle="{$dataBassin[lst].bassin_id}"
								value="{$dataBassin[lst].ration_commentaire_precedent}" size="30" readonly>
					...
					<div class="form-group">
						...
						<dd>
							Évolution :
							<input class="num5 evol" name="evol_taux_nourrissage_{$dataBassin[lst].bassin_id}"
								id="evol_taux_nourrissage_{$dataBassin[lst].bassin_id}"
								data-cle="{$dataBassin[lst].bassin_id}"
								value="{$dataBassin[lst].evol_taux_nourrissage}">
							Nouveau taux :
							<input class="num5 taux" name="taux_nourrissage_{$dataBassin[lst].bassin_id}"
								id="taux_nourrissage_{$dataBassin[lst].bassin_id}"
								data-cle="{$dataBassin[lst].bassin_id}" value="{$dataBassin[lst].taux_nourrissage}">


							<div class="form-group">
								<label for="" class="control-label col-md-4">{t}Ration distribuée :{/t}</label>
								<div class="col-md-8">
									<input id="" class="form-control" class="num10 ration"
									...
									<input name="distribution_consigne_{$dataBassin[lst].bassin_id}"
										...
										data-cle="{$dataBassin[lst].bassin_id}"
										value="{$dataBassin[lst].distribution_consigne}" placeholder="Consignes..."
										Title="Consignes de distribution" size="30">
						...
						<dd>
							lun <input type="checkbox" name="distribution_jour_1_{$dataBassin[lst].bassin_id}" value="1"
								{if $dataBassin[lst].distribution_jour_1==1}checked{/if}>
							mar <input type="checkbox" name="distribution_jour_2_{$dataBassin[lst].bassin_id}" value="1"
								{if $dataBassin[lst].distribution_jour_2==1}checked{/if}>
							mer <input type="checkbox" name="distribution_jour_3_{$dataBassin[lst].bassin_id}" value="1"
								{if $dataBassin[lst].distribution_jour_3==1}checked{/if}>
							jeu <input type="checkbox" name="distribution_jour_4_{$dataBassin[lst].bassin_id}" value="1"
								{if $dataBassin[lst].distribution_jour_4==1}checked{/if}>
							ven <input type="checkbox" name="distribution_jour_5_{$dataBassin[lst].bassin_id}" value="1"
								{if $dataBassin[lst].distribution_jour_5==1}checked{/if}>
							sam <input type="checkbox" name="distribution_jour_6_{$dataBassin[lst].bassin_id}" value="1"
								{if $dataBassin[lst].distribution_jour_6==1}checked{/if}>
							dim <input type="checkbox" name="distribution_jour_7_{$dataBassin[lst].bassin_id}" value="1"
								{if $dataBassin[lst].distribution_jour_7==1}checked{/if}>
				...
				<div class="form-group">
					...
					<dd>
						lun <input type="checkbox" name="distribution_jour_soir_1_{$dataBassin[lst].bassin_id}"
							value="1" {if $dataBassin[lst].distribution_jour_soir_1==1}checked{/if}>
						mar <input type="checkbox" name="distribution_jour_soir_2_{$dataBassin[lst].bassin_id}"
							value="1" {if $dataBassin[lst].distribution_jour_soir_2==1}checked{/if}>
						mer <input type="checkbox" name="distribution_jour_soir_3_{$dataBassin[lst].bassin_id}"
							value="1" {if $dataBassin[lst].distribution_jour_soir_3==1}checked{/if}>
						jeu <input type="checkbox" name="distribution_jour_soir_4_{$dataBassin[lst].bassin_id}"
							value="1" {if $dataBassin[lst].distribution_jour_soir_4==1}checked{/if}>
						ven <input type="checkbox" name="distribution_jour_soir_5_{$dataBassin[lst].bassin_id}"
							value="1" {if $dataBassin[lst].distribution_jour_soir_5==1}checked{/if}>
						sam <input type="checkbox" name="distribution_jour_soir_6_{$dataBassin[lst].bassin_id}"
							value="1" {if $dataBassin[lst].distribution_jour_soir_6==1}checked{/if}>
						dim <input type="checkbox" name="distribution_jour_soir_7_{$dataBassin[lst].bassin_id}"
							value="1" {if $dataBassin[lst].distribution_jour_soir_7==1}checked{/if}>
