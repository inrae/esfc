...
- correction du contrôleur : quand une page est appelée en mode 'ajax', elle n'est plus stockée dans la variable module_before, ce qui pouvait poser quelques problèmes dans les fiches de saisie qui utilisaient des requêtes ajax et où ce paramètre avait été positionné
